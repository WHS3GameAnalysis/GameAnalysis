    ...
    internal class Settings
    {
        ...
        internal class Changelog
        {
            ...
            public static void ReadChanges()
            {
                ...
                using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("GHBCheat.Resources.Changelog.txt"))
        ...
        {
            public static string config = "GHBCheat.config.json";
            public static string defaultConf = "GHBCheat.default.config.json";
