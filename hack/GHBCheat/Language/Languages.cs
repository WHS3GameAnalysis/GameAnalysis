...
namespace GHBCheat.Language
{
    ...
    public class Localization
    {
        ...
        {
            Assembly.GetExecutingAssembly().GetManifestResourceNames().Where(x => x.StartsWith("GHBCheat.Resources.Language.") && x.EndsWith(".json")).ToList().ForEach(x =>
            {
                string jsonStr = null;
                try
                {
