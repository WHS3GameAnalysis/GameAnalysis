...
namespace GHBCheat
{
    ...
    public class HackExecutor
    {
        ...
        //public static void UnloadMenu() => GHBCheat.Instance.Unload();
        ...
        //public static void SellQuota() => GHBCheat.localPlayer.Handle().SellQuota();
        //public static void SellEverything() => GHBCheat.localPlayer.Handle().PlaceEverythingOnDesk();
        ...
        //public static void SaveTeleportPosition() => GHBCheat.localPlayer.Handle().SavePosition();
        //public static void TeleportShip() => GHBCheat.localPlayer.Handle().TeleportShip();
        //public static void TeleportSavedPosition() => GHBCheat.localPlayer.Handle().TeleportSaved();
        //public static void Teleport(Vector3 pos, bool elevator = false, bool ship = false, bool factory = false) => GHBCheat.localPlayer.Handle().Teleport(pos, elevator, ship, factory);
        ...
        //public static void KillNearbyEnemies(int distance = -1) => GHBCheat.enemies.FindAll(e => GameUtil.GetDistanceToPlayer(e.transform.position) <= distance).ForEach(enemy => enemy.Handle().Kill());
        ...
        //public static void ToggleTerminalSound() => GHBCheat.Instance.StartCoroutine(RoundHandler.ToggleTerminalSound());
        ...
        //public static void SpamShootAllShotguns() => GHBCheat.Instance.StartCoroutine(RoundHandler.SpamShootAllShotguns());
        ...
        //public static void ExplodeJetpacksOnGrab() => GHBCheat.Instance.StartCoroutine(RoundHandler.ExplodeJetpacksOnGrab());
